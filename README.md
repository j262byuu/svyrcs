...
and the confidence band uses Taylor linearisation on the design degrees of freedom.
...
| chi-square *p*-values | design-based *F* on `(df1, degf)` | with 31 design degrees of freedom the chi-square test is anti-conservative; the *F* test matches `survey::regTermTest()` |
